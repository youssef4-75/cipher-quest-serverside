        ...
        phases: [
            {
                ...
                messages: [
                    { id: 1, text: "Adding two numbers", hash: 24},
                    { id: 2, text: "Searching a sorted list", hash: 301},
                    { id: 3, text: "Sorting a list", hash: 4}
                ],
            ...
            },
            {
                ...
                messages: [
                    { id: 1, text: "Array", hash: 45},
                    { id: 2, text: "Linked List", hash: 120},
                    { id: 3, text: "Binary Tree", hash: 87}
                ],
            ...
            },
            {
                ...
                messages: [
                    { id: 1, text: "Variables", hash: 16},
                    { id: 2, text: "Functions", hash: 165},
                    { id: 3, text: "Classes", hash: 19}
                ],
        ...
        phases: [
            {
                ...
                messages: [
                    { id: 1, text: "Electron", hash: 842},
                    { id: 2, text: "Proton", hash: 193},
                    { id: 3, text: "Atom", hash: 557}
                ],
            ...
            },
            {
                ...
                messages: [
                    { id: 1, text: "Ground state", hash: 928},
                    { id: 2, text: "Excited state", hash: 476},
                    { id: 3, text: "Ionized state", hash: 315}
                ],
            ...
            },
            {
                ...
                messages: [
                    { id: 1, text: "Wave nature", hash: 203},
                    { id: 2, text: "Particle nature", hash: 741},
                    { id: 3, text: "Entanglement", hash: 588}
                ],
        ...
        phases: [
            {
                ...
                messages: [
                    { id: 1, text: "If-Then rules", hash: 412},
                    { id: 2, text: "Decision trees", hash: 879},
                    { id: 3, text: "Neural networks", hash: 253}
                ],
            ...
            },
            {
                ...
                messages: [
                    { id: 1, text: "Chess programs", hash: 781},
                    { id: 2, text: "Face recognition", hash: 346},
                    { id: 3, text: "ChatGPT", hash: 925}
                ],
        ...
        phases: [
            {
                ...
                messages: [
                    { id: 1, text: "Solar", hash: 729},
                    { id: 2, text: "Wind", hash: 386},
                    { id: 3, text: "Coal", hash: 154}
                ],
            ...
            },
            {
                ...
                messages: [
                    { id: 1, text: "Recycling", hash: 293},
                    { id: 2, text: "Composting", hash: 678},
                    { id: 3, text: "Solar panels", hash: 451}
                ],
        ...
        phases: [
            {
                ...
                messages: [
                    { id: 1, text: "Stone Age", hash: 3500},
                    { id: 2, text: "Bronze Age", hash: 1792},
                    { id: 3, text: "Iron Age", hash: 2100}
                ],
            ...
            },
            {
                ...
                messages: [
                    { id: 1, text: "Egypt", hash: 2686},
                    { id: 2, text: "Greece", hash: 2055},
                    { id: 3, text: "Rome", hash: 1550}
                ],
        ...
        phases: [
            {
                ...
                messages: [
                    { id: 1, text: "The inexistant classroom in the hall B (write b...).", hash: 1},
                    { id: 4, text: "INPT is known by Z....", hash: 2},
                    { id: 5, text: "the eye of life", hash: 5}
                ],
                password: "b216Zlafa7ayat",
                explanation: "This phase combines specific knowledge about INPT: 1) B216 is the hall that doesn't exist in the Hall B, 2) INPT's major sign: Zlafa, 3) The eye of life is called 7ayat. This sequence reveals specific details about INPT's physical layout and organizational structure.",
            },
            {
                description: "these questions have answers, the attached numbers represent the answer, but one message have a wrong answer, find the fake answer and write down the correct one to move to the next layer",
                messages: [
                    { id: 1, text: "how many majors are there at INPT", hash: 7},
                    { id: 2, text: "how many period INPT uses", hash: 4},
                    { id: 3, text: "how many halls are there at INPT", hash: 5},
                    { id: 4, text: "how many pavillon exists in the institute", hash: 3},
                    { id: 5, text: "how many classes are there in the second floor of hall B", hash: 22},
                    { id: 6, text: "how many clubs existed in INPT at the year 2024/2025", hash: 13},
                ],
                password: "21",
                explanation: "Hall B contains only 21 classroom, even if the last classroom in the hall B is numbered 222, but since 216 doesn't exist, there are only 21 classroom",
            },
            {
                description: "Order these clubs starting from the best one to the least one, commite masjid not included since its not a club, otherwise it will be the best one, numbers are next to each other with no spacing",
                messages: [
                    { id: 1, text: "CAS", hash: 20},
            ...
            },
            {
                ...
                messages: [
                    { id: 1, text: "ASEDS", hash: 0},
                    { id: 2, text: "ICCN", hash: 0},
                    { id: 3, text: "DATA", hash: 0},
                    { id: 4, text: "SMART", hash: 0},
                    { id: 5, text: "CLOUD", hash: 0},
                    { id: 6, text: "SESNum", hash: 0},
                    { id: 7, text: "AMOA", hash: 0}
                ],
                password: "ASEDS",
        ...
        phases: [
            {
                ...
                messages: [
                    { id: 1, text: "Atom", hash: 842},
                    { id: 2, text: "Molecule", hash: 193},
                    { id: 3, text: "Cell", hash: 557}
                ],
            ...
            },
            {
                ...
                messages: [
                    { id: 1, text: "Tissue", hash: 928},
                    { id: 2, text: "Organ", hash: 476},
                    { id: 3, text: "System", hash: 315}
                ],
        ...
        phases: [
            {
                ...
                messages: [
                    { id: 1, text: "Calculator", hash: 412},
                    { id: 2, text: "Personal computer", hash: 879},
                    { id: 3, text: "Smartphone", hash: 253}
                ],
            ...
            },
            {
                ...
                messages: [
                    { id: 1, text: "Floppy disk", hash: 781},
                    { id: 2, text: "CD", hash: 346},
                    { id: 3, text: "USB drive", hash: 925}
                ],
        ...
        phases: [
            {
                ...
                messages: [
                    { id: 1, text: "Electric cars", hash: 729},
                    { id: 2, text: "Mobile phones", hash: 386},
                    { id: 3, text: "Social media", hash: 154}
                ],
            ...
            },
            {
                ...
                messages: [
                    { id: 1, text: "Local change", hash: 293},
                    { id: 2, text: "National change", hash: 678},
                    { id: 3, text: "Global change", hash: 451}
                ],
